...
export class Backend implements backendInterface {
    ...
    async addLesson(arg0: bigint, arg1: Lesson): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addLesson(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addModule(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addQuestion(arg0: bigint, arg1: Question): Promise<void> {
        if (this.processError) {
            try {
    ...
    async completeLesson(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
